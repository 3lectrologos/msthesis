...
%\setlength\figureheight{1.2in}\setlength\figurewidth{3.5in}
%\input{figures/limno_chl_fp.tex}

\begin{figure}[tb]
  \centering
  \includegraphics[width=3.8in,clip,trim=7pt 7pt 7pt 7pt]{figures/limno_chl_fp}
