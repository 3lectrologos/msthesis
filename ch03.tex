...
%\input{figures/limno_bgape_imp_class50.tex}
%\input{figures/limno_bgape_imp_class100.tex}
%\input{figures/limno_bgape_imp_class200.tex}
%\input{figures/limno_bgape_imp_class440.tex}
\renewcommand\trimlen{3pt}
\begin{figure}[tb]
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_bgape_imp_class50}
    \caption{$t = 50$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_bgape_imp_class100}
    \caption{$t = 100$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    ...
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_bgape_imp_class200}
    \caption{$t = 200$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_bgape_imp_class440}
