...
\begin{figure}[tb]
  ...
  (c)--(f) \acl after $t = 50, 75, 100$, and $168$ iterations respectively,
      run on a regular grid of $100\times 100$ points:
...
of running the \acl algorithm on the chlorophyll dataset of
\figref{fig:limno_chl}. Note how the sampling process focuses on the ambiguous
regions around the desired level set until all points in $D$ have been
