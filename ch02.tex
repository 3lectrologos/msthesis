...
\begin{figure}[tb]
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \includegraphics[height=1.7in]{figures/class}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \includegraphics[height=1.7in]{figures/amb}
    \caption{Ambiguities}
    \label{fig:amb}
  \end{subfigure}
  \caption{
    (a) Example of the three possible configurations of confidence regions:
        $\*x$ will be classified into $H_t$, $\*x''$ into $L_t$, whereas
        $\*x'$ will remain unclassified.
    (b) Ambiguities of two example points: $\*x$ is a point of high ambiguity
        (close to $w_t(\*x)/2$), while $\*x'$ has low ambiguity (close to
        $\epsilon$).
  }
\end{figure}
...
values close to $\epsilon$ indicate that $\*x$ is close to being classified
...
%\input{figures/limno_chl_class200.tex}
%\input{figures/limno_chl_class405.tex}
\renewcommand\trimlen{3pt}
\begin{figure}[tb]
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_chl_class50}
    \caption{$t = 50$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_chl_class100}
    \caption{$t = 100$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    ...
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_chl_class200}
    \caption{$t = 200$}
  ...
  \begin{subfigure}[b]{0.49\linewidth}
    \centering
    \adjincludegraphics[width=\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/limno_chl_class405}
