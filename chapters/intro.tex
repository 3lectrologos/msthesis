...
\begin{figure}[tb]
  \begin{subfigure}[b]{\linewidth}
    \centering
    \adjincludegraphics[width=0.78\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/ch01/limno_chl_fp}
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \hspace{-2.3em}
    \adjincludegraphics[width=0.717\linewidth,clip=true,trim=\trimlen{} \trimlen{} \trimlen{} \trimlen{}]{figures/ch01/limno_chl_res}
