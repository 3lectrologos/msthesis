...
As can be seen in \figref{fig:bgape-imp-istr-sc}, this leads to most
of the executions of \istr achieving an $F_1$-score of only about
0.8. The inability of \istr to recover from a wrong
...
no tendency of improvement thereafter. The behavior of \iacl depicted in
